async function uploadImage(event) {
    ...
    function openSidebar() {
        ...
        document.getElementById("main-content").style.marginLeft = "250px"; /* تم تغيير marginRight إلى marginLeft */
    }

    function closeSidebar() {
        document.getElementById("sidebar").style.width = "0";
        document.getElementById("main-content").style.marginLeft = "0"; /* تم تغيير marginRight إلى marginLeft */
    }
...
function updatePriceImages1() {
        fetch('/update-price-images1')
            .then(response => response.json())
            .then(data => {
                if (data.success) {
                    alert('تم تحديث الصور بنجاح!');
...
function updatePricImages() {
    fetch('/update-pric-images')
    .then(response => response.json())
    .then(data => {
        if (data.success) {
            alert('تم تحديث الصور بنجاح!');
...
function updatePricNazmImages() {
	fetch('/update-price-nazm-images')
	.then(response => response.json())
	.then(data => {
		if (data.success) {
			alert('تم تحديث الصور بنجاح!');
...
function updatePricNazmImages1() {
	fetch('/update-price-nazm-images1')
	.then(response => response.json())
	.then(data => {
		if (data.success) {
			alert('تم تحديث الصور بنجاح!');
